			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						$query = mysql_query("SELECT * FROM data_return where kode_return='$kode_return'") or die(mysql_error());
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
															<div class="row">
						<a href="update.php"><button class="btn btn-success">Daftar Return Barang</button></a>
						<br>
						<br>
							<div class="col-xs-12">
							<?php
								include '../koneksi.php';
					            $query1   	= mysql_query("SELECT max(kode_return) as maxid from data_return");
        					...
        					?>
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="kode_brg" name="harga" placeholder="Rp. 10.0000" class="col-xs-10 col-sm-5"  onkeyup="kali()" required="required" />
										</div>
									</div>
