				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<?php
								...
								$query = mysql_query("SELECT a.`kode_pengiriman`,a.`tgl_pengiriman`,a.`jumlah_barang`,b.`kode_toko`,b.`nama_toko`,c.`brand`,d.`status` FROM pengiriman AS a LEFT JOIN store AS b ON a.`kode_toko`=b.`kode_toko` LEFT JOIN barang	AS c ON a.`kode_barang`=c.`kode_barang`  JOIN status_barang AS d ON a.`kode_status_pengiriman`=d.`id") or die(mysql_error());
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="update_pengiriman.php" method="post">
								<div class="form-group">
										<label class="col-sm-3 control-label" for="form-field-1"> Kode Pemgiriman </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="kode_pengiriman" placeholder="Kode Pengiriman" class="col-xs-10 col-sm-5" readonly="readonly" value="<?php echo $data['kode_pengiriman']; ?>" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="date" id="form-field-1" name="tgl_pengiriman" placeholder="26 mei 2017" class="col-xs-10 col-sm-5" required="required" value="<?php echo $data['tgl_pengiriman'] ?>" />
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="kode_barang" name="harga_satuan" placeholder="Rp. 10.0000" class="col-xs-10 col-sm-5"  value="<?php echo $data['harga_satuan'] ?>" />
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="jumlah_barang"  placeholder="10 pcs" class="col-xs-10 col-sm-5" value="<?php echo $data['jumlah_barang'] ?>">
										</div>
									</div>
									<span id="hasil">
									<script type="text/javascript">
